  ...
  try {
    ...
    if (!data.text || !data.userId) {
      ...
      throw new functions.https.HttpsError(
          "invalid-argument",
          "Required field (text or userId) are missing",
      );
    }
    ...
    // Add message to the user's mesage subcollection in Firestore
    ...
    logger.log("Message addedsuccessfully, message Id:", messageRef.id);
